...
//           admin123  → hash below
//           faculty123→ hash below
//           student123→ hash below
// ════════════════════════════════════════════════════════
function seed() {
  if (DB.isSeeded()) return;

  // Pre-computed SHA-256 hashes (via Auth.hash at runtime would be async,
  // so we use synchronous CryptoJS here for seed only)
  const H = {
    admin:   CryptoJS.SHA256('admin123').toString(),
    faculty: CryptoJS.SHA256('faculty123').toString(),
    student: CryptoJS.SHA256('student123').toString(),
  };

  DB.s('users', [
    {id:1, u:'admin',     p:H.admin,   role:'admin',   lid:null, name:'Admin'},
    {id:2, u:'srk',       p:H.faculty, role:'faculty', lid:1,    name:'Shah Rukh Khan'},
    {id:3, u:'priyanka',  p:H.faculty, role:'faculty', lid:2,    name:'Priyanka Chopra'},
    {id:4, u:'rajini',    p:H.faculty, role:'faculty', lid:3,    name:'Rajini Kanth'},
    {id:5, u:'rashmika',  p:H.faculty, role:'faculty', lid:4,    name:'Rashmika Mandanna'},
    {id:6, u:'prabhas',   p:H.student, role:'student', lid:1,    name:'Prabhas'},
    {id:7, u:'katrina',   p:H.student, role:'student', lid:2,    name:'Katrina Kaif'},
    {id:8, u:'allu',      p:H.student, role:'student', lid:3,    name:'Allu Arjun'},
    // extra students for pagination demo
    {id:9, u:'samantha',  p:H.student, role:'student', lid:4,    name:'Samantha Prabhu'},
    {id:10,u:'yash',      p:H.student, role:'student', lid:5,    name:'Yash'},
    {id:11,u:'mrunal',    p:H.student, role:'student', lid:6,    name:'Mrunal Thakur'},
  ...
  DB.s('students', [
    {id:1,  fn:'Prabhas',  ln:'',          em:'prabhas@uni.edu',   ph:'555-0101', dept:'Computer Science', yr:'2', dob:'2003-05-12', status:'Active',   addr:'12 Main St',   adm:'2023'},
    {id:2,  fn:'Katrina',  ln:'Kaif',      em:'katrina@uni.edu',   ph:'555-0102', dept:'Mathematics',      yr:'3', dob:'2002-08-22', status:'Active',   addr:'45 Oak Ave',   adm:'2022'},
    {id:3,  fn:'Allu',     ln:'Arjun',     em:'allu@uni.edu',      ph:'555-0103', dept:'Computer Science', yr:'1', dob:'2004-01-15', status:'Active',   addr:'78 Pine Rd',   adm:'2024'},
    {id:4,  fn:'Samantha', ln:'Prabhu',    em:'samantha@uni.edu',  ph:'555-0104', dept:'Physics',          yr:'4', dob:'2001-11-30', status:'Active',   addr:'33 Elm St',    adm:'2021'},
    {id:5,  fn:'Yash',     ln:'',          em:'yash@uni.edu',      ph:'555-0105', dept:'Business',         yr:'2', dob:'2003-03-18', status:'Active',   addr:'90 Maple Dr',  adm:'2023'},
    {id:6,  fn:'Mrunal',   ln:'Thakur',    em:'mrunal@uni.edu',    ph:'555-0106', dept:'Computer Science', yr:'3', dob:'2002-06-07', status:'Active',   addr:'14 Oak St',    adm:'2022'},
  ...
  DB.s('fees', [
    {id:1, sid:1,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Paid',    paid:'2025-02-10'},
    {id:2, sid:1,  type:'Library',   amt:100,  due:'2025-02-15', status:'Paid',    paid:'2025-02-10'},
    {id:3, sid:1,  type:'Lab',       amt:200,  due:'2025-03-01', status:'Paid',    paid:'2025-02-28'},
    {id:4, sid:2,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Pending', paid:''},
    {id:5, sid:3,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Overdue', paid:''},
    {id:6, sid:4,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Paid',    paid:'2025-02-08'},
    {id:7, sid:5,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Paid',    paid:'2025-02-12'},
    {id:8, sid:6,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Pending', paid:''},
    {id:9, sid:9,  type:'Tuition',   amt:5000, due:'2025-02-15', status:'Paid',    paid:'2025-02-05'},
    {id:10,sid:10, type:'Tuition',   amt:5000, due:'2025-02-15', status:'Overdue', paid:''},
    {id:11,sid:11, type:'Tuition',   amt:5000, due:'2025-02-15', status:'Pending', paid:''},
  ]);
  ...
  DB.s('exams', [
    {id:1, cid:1, date:'2025-04-28', time:'09:00', hall:'Hall A', dur:120},
    {id:2, cid:2, date:'2025-04-30', time:'14:00', hall:'Hall B', dur:180},
    {id:3, cid:3, date:'2025-05-02', time:'09:00', hall:'Hall A', dur:120},
    {id:4, cid:5, date:'2025-05-05', time:'10:00', hall:'Hall C', dur:150},
    {id:5, cid:4, date:'2025-05-06', time:'09:00', hall:'Hall B', dur:120},
    {id:6, cid:6, date:'2025-05-07', time:'14:00', hall:'Hall D', dur:120},
  ]);

  DB.s('announcements', [
    {id:1, title:'Spring 2025 Final Exam Schedule', body:'Final exams begin April 28. Please review the timetable on the portal and ensure your hall ticket is downloaded.',                   aud:'All',      pri:'High',   date:'2025-03-20', author:'Admin'},
    {id:2, title:'Library Extended Hours',          body:'Library will be open until 11 PM during exam prep week (Apr 21–27). Silence must be maintained in all reading rooms.',              aud:'Students', pri:'Normal', date:'2025-03-18', author:'Admin'},
    {id:3, title:'Faculty Meeting — Friday',        body:'Mandatory faculty meeting in Conference Room B at 3 PM. Attendance is compulsory. Please bring grade submission reports.',          aud:'Faculty',  pri:'Urgent', date:'2025-03-15', author:'Admin'},
    {id:4, title:'Fee Payment Reminder',            body:'Tuition fees for Spring 2025 are due by February 15. Students with overdue fees may be blocked from exam registration.',           aud:'Students', pri:'High',   date:'2025-02-01', author:'Admin'},
    {id:5, title:'Campus Placement Drive',          body:'TechCorp and FinanceHub will be visiting campus on April 10 for placement. Final-year students are encouraged to register by Apr 5.',aud:'Students', pri:'Normal', date:'2025-03-25', author:'Admin'},
  ]);

  DB.s('assignments', [
    {id:1, cid:1, title:'Python Basics Quiz',          due:'2025-02-28', marks:20,  wt:10, inst:'Complete all 20 questions. Covers variables, loops and functions.'},
    {id:2, cid:2, title:'Binary Tree Implementation',  due:'2025-03-10', marks:50,  wt:20, inst:'Implement insert, delete and search. Include time complexity analysis.'},
    {id:3, cid:3, title:'Differentiation Problem Set', due:'2025-03-15', marks:30,  wt:15, inst:'Solve problems 1–20 from Chapter 4. Show all working steps.'},
    {id:4, cid:5, title:'ER Diagram Assignment',       due:'2025-03-20', marks:40,  wt:25, inst:'Design a complete database schema for a library management system.'},
    {id:5, cid:1, title:'OOP Mini Project',            due:'2025-04-05', marks:100, wt:30, inst:'Build a small OOP project (e.g., bank system, inventory). Include UML diagram.'},
    {id:6, cid:6, title:'Financial Statement Analysis',due:'2025-04-01', marks:60,  wt:20, inst:'Analyse provided P&L and balance sheet. Prepare ratio analysis report.'},
  ]);

  DB.s('submissions', []);

  DB.s('leaves', [
    {id:1, sid:3,  cid:1, from:'2025-02-20', to:'2025-02-22', reason:'Medical appointment — doctor visit for chronic condition.', type:'Medical', status:'Pending',  date:'2025-02-18'},
    {id:2, sid:2,  cid:3, from:'2025-02-15', to:'2025-02-16', reason:'Family event — sister wedding.',                             type:'Family',  status:'Approved', date:'2025-02-12'},
    {id:3, sid:1,  cid:2, from:'2025-02-10', to:'2025-02-10', reason:'Doctor visit for annual check-up.',                          type:'Medical', status:'Rejected', date:'2025-02-08'},
  ]);
  ...
  DB.s('events', [
    {id:1, title:'Spring Semester Begins',        date:'2025-01-13', type:'Event'},
    {id:2, title:'Mid-term Exams',                date:'2025-03-03', type:'Exam'},
    {id:3, title:'Spring Break',                  date:'2025-03-17', type:'Holiday'},
    {id:4, title:'Final Exams Begin',             date:'2025-04-28', type:'Exam'},
    {id:5, title:'Summer Break',                  date:'2025-05-12', type:'Holiday'},
    {id:6, title:'Assignment — CS101 Python Quiz',date:'2025-02-28', type:'Deadline'},
    {id:7, title:'Assignment — CS201 Binary Tree',date:'2025-03-10', type:'Deadline'},
    {id:8, title:'Campus Placement Drive',        date:'2025-04-10', type:'Event'},
  ]);
  ...
  DB.s('notifications', [
    ...
    {id:2, title:'Fee Overdue',        body:'Your tuition fee for Spring 2025 is overdue.',              tag:'fee',        read:false, uid:3,  ts:Date.now()-86400000},
  ...
  DB.s('audit', [
    ...
    {id:5, action:'Exam Scheduled',   detail:'CS101 exam scheduled for April 28',           user:'admin',    ts:Date.now()-3600000,    color:'var(--teal)'},
